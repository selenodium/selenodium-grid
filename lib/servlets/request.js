...
function newSession(req, registry, driver) {
    ...
    log.debug('Got new session request with capabilities: %j', req.capabilities);
...
// 9 UnknownCommand - The requested resource could not be found, or a request was received
